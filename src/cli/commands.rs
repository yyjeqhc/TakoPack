...
use takopack::cargo_packaging::crates::invalidate_crates_io_cache;
use takopack::cargo_packaging::package::*;
use takopack::cargo_packaging::range_audit::{self, RangeCapabilityPolicy};
use takopack::cargo_packaging::recursive::RecursivePackager;
use takopack::cargo_packaging::spec_from_toml::parse_dependencies_from_toml;
    ...
    match m.command {
        Cargo(cargo_opt) => match cargo_opt {
            ...
            CargoOpt::Batch { file, output } => {
                ...
                takopack::cargo_packaging::batch::process_batch_file(&file, output)?;
                Ok(0)
            }
